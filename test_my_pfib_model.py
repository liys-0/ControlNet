...
python test_headless.py \
  ...
  --output_folder "/homes/yusha/POC_Dataset/for_ControlNet/avalon_generated_results" \
  --checkpoint "./lightning_logs/version_5085/checkpoints/epoch=23-step=5000.ckpt" \
  --prompt "normal pfib" \
  --num_samples 100
""" 
...
#)
model.load_state_dict(
    load_state_dict("./lightning_logs/version_X/checkpoints/epoch=Y-step=Z.ckpt", location="cuda")
)
model = model.cuda()
